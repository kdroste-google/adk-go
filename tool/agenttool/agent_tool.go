...
// the final result.
func (t *agentTool) Run(toolCtx tool.ToolContext, args any) (map[string]any, error) {
...
func (t *agentTool) ProcessRequest(ctx tool.ToolContext, req *model.LLMRequest) error {
