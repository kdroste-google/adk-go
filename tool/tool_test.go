...
func TestTypes(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "FunctionTool",
			constructor: func() (tool.Tool, error) {
				return functiontool.New(functiontool.Config{}, func(_ tool.ToolContext, input intInput) (intOutput, error) {
...
func TestWithConfirmation(t *testing.T) {
	toolRan := false
	noOpTool, err := functiontool.New(functiontool.Config{Name: "noOpTool"}, func(ctx tool.ToolContext, input struct{}) (struct{}, error) {
		toolRan = true
		return struct{}{}, nil
	})
	if err != nil {
