...
import (
	...
	"google.golang.org/adk/cmd/launcher/web/agentengine"
...
func NewLauncher() launcher.Launcher {
	return universal.NewLauncher(console.NewLauncher(), web.NewLauncher(webui.NewLauncher(), a2a.NewLauncher(), pubsub.NewLauncher(), api.NewLauncher(), agentengine.NewLauncher()))
}
